...
import educationSankey from "../data/chartLib/education.json";
import heatMapData from "../data/chartLib/heatMap";

import { testData } from "../data/chartLib/testData";
...
interface ChartLibProps {}

const ChartLib: React.FC<ChartLibProps> = ({}) => {
    ...
    <section>
      <div style={{ flexGrow: 1, padding: "2rem" }}>
        ...
        <Typography
          ...
          gutterBottom
        >
          A data visualisation library built for react.
        </Typography>
        <Grid
          container
          spacing={1}
